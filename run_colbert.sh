...
for i in "${!DATASET_ARRAY[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=1 python main_colbert_for_odr.py dataset=$DATASET device=0 print_dataset=False xnhead=$HEAD samp_rate_step=$STEP xnumlayers=2 expt_id=$EXPT_ID n_samp_odc=719 &
