# Legacy argument parser for the main.py script
# Refer to this file for details on the arguments used in the script
# This parser is no longer used, and is only for reference. Some argument defaults and types may have changed, and newer arguments may not be included
