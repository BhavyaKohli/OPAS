...
from main_early_interaction import *
...
def load_models(name="best", expt_root=None, device="cpu"):
    ...
    embed_model_inner = torch.load(f"{expt_root}/embed_model_inner{suffix}.pt", map_location=device, weights_only=False)
...
if __name__ == "__main__":
    ...
    model, scoremodel, embed_model, embed_model_inner, preembed_model, aggregator = load_models(name="best", expt_root=expt_root, device=DEVICE)
